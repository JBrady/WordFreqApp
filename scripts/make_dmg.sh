...
echo "Layout defaults:"
echo "  DMG_LAYOUT_OFFSET_X=$LAYOUT_OFFSET_X DMG_LAYOUT_OFFSET_Y=$LAYOUT_OFFSET_Y"
echo "  bounds={$WIN_X, $WIN_Y, $WIN_X2, $WIN_Y2}"
echo "  app={$APP_POS_X, $APP_POS_Y} applications={$APPS_POS_X, $APPS_POS_Y}"
